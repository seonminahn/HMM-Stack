...
function total_likeli_prob = total_likeli_sample_point_global_min_pi_begin_fine(sample_seq,pi_0,log_tao_x_begin,log_tao_y_begin,log_tao_x_end,log_tao_y_end,log_delta_match,log_delta_end,ratio_track,dis_bin_input_new,log_grid,log_input_gap_raw,aaa,transition_prob_track,ratio_track_new,group_transition)
pi_begin =[aaa(1) aaa(2) 1-aaa(1)-aaa(2)];
